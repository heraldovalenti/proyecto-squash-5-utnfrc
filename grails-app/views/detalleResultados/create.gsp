...
<html>
	...
	<body>
		<a href="#create-detalleResultados" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>				
				<li><g:link class="list" action="list"><g:message code="Detalles de Resultados" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="create-detalleResultados" class="content scaffold-create" role="main">
