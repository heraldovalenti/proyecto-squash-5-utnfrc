		...
		<div class="moduleContentInner">
			<div class="head2headPremade">
				<div class="actionShot IE6pngFix">
					<a href="perfiles/j8/easdale-guillermo.html" class="raised"><img
						width="111" height="149" alt="EASDALE, GUILLERMO"
						title="EASDALE, GUILLERMO"
						src="images/img.php?src=http://www.acsr.com.ar/images/perfiles/8.jpg&w=111&h=149&zc=1"></a>
				</div>
				<div class="head2headPreStats raised IE6pngFix">
					<h4>HISTORIAL DE PARTIDOS</h4>
					<a class="head2headPreName1 pb10"
						href="perfiles/j8/easdale-guillermo.html">EASDALE, GUILLERMO</a> <a
						class="head2headPreName2 pb10"
						href="perfiles/j1/d-arcangelo-hernan-javier.html">D`ARCANGELO,
						HERNAN JAVIER</a>
					<p class="head2headPreScore">2 - 46</p>
					<p class="head2headPreLinks mt10">
						<a
							href="http://www.acsr.com.ar/index.php?c=head2head&amp;pId=8&amp;oId=1"
							class="genericButton"><span>Ver Detalles</span></a>
					</p>
				</div>
				<div class="actionShot  IE6pngFix">
					<a href="perfiles/j1/d-arcangelo-hernan-javier.html" class="raised"><img
						width="111" height="149" alt="D`ARCANGELO, HERNAN JAVIER"
						title="D`ARCANGELO, HERNAN JAVIER"
						src="images/img.php?src=http://www.acsr.com.ar/images/perfiles/1.jpg&w=111&h=149&zc=1"></a>
				</div>
			</div>
			<p>
				Ingrese el apellido de los jugadores y seleccionar de la lista para
			...
			<form action="#" method="get" class="head2headEntryFields">
				<div class="head2headEntryField1">
					<input type="text" value="Ingresar Jugador 1" id="autoComp1"
						...
						type="hidden" name="pId" id="pId" class="autoCompId">
					<div id="resultspId" class="results results-h2h raised"></div>
				</div>
				<p>VS</p>
