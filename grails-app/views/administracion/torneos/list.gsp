...
<html>
	...
	<body>
				...
				<fieldset class="buttons">
    				<g:link controller="torneo" action="nuevoTorneo"><span  style="position: absolute; height: 20px"class="ui-icon ui-icon-circle-plus"></span><span style="padding-left: 18px;">Nuevo Torneo</span> </g:link> 	
				</fieldset>
