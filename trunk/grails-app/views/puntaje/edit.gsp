...
<html>
	...
	<body>
		...
		<div id="edit-puntaje" class="content scaffold-edit" role="main">
			...
			<ul class="errors" role="alert">
				<g:eachError bean="${puntajeInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${puntajeInstance?.version}" />
				<fieldset class="form">
